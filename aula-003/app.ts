...
const arrayDeStrings: string[] = ["Oi", "Olá", "Mundo"];
/**
 * Pouco aconselhável usar um array com muitos tipos diferentes de dados
 */
const outraFormaDeCriarArray: Array<string | number | boolean | Array<string>> =
  [];
const arrayDeMultiplosTiposDeDados: (number | string)[] = [];
